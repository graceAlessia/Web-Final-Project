        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mt-5">
            <?php if ($isUserLoggedIn): ?>
                ...
                <p class="text-center mt-3">
                    <a href="#" class="text-light" style="text-decoration: none;" onclick="clearHistory()">Clear history</a>
                </p>
            <?php else: ?>
                <h4 class="text-center text-info">
                    <a href="login.php" style="color: white; text-decoration: none;">Please log in to view password history.</a>
                </h4>
            <?php endif; ?>
        </div>
    </div>
