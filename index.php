...
<head>
    ...
    <link rel="stylesheet" href="path/to/your/styles.css"> <!-- Add your main stylesheet link here -->
    <style>
        .tooltip {
            position: absolute;
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <?php else: ?>
                    <h4 class="text-center text-info">
                        <a href="login.php" style="color: #82C5FF; text-decoration: none;">Please log in to view password history.</a>
                    </h4>
                <?php endif; ?>
            </div>
        </div>
